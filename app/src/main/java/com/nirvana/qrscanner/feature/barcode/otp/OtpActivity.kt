package com.nirvana.qrscanner.feature.barcode.otp
...
import com.nirvana.qrscanner.di.otpGenerator
import com.nirvana.qrscanner.extension.applySystemWindowInsets
import com.nirvana.qrscanner.extension.orZero
...
class OtpActivity : BaseActivity() {
    ...
    private fun showOtp() {
        ...
        text_view_password.text = otpGenerator.generateOTP(otp)
                ?: getString(R.string.activity_barcode_otp_unable_to_generate_otp)
    }
